...
object DarkSkySchema {
  ...
  val CURRENTLY_STRUCT= new StructType()
    ...
    .add(TIME_FIELD,DataTypes.TimestampType)
    ...
    .add(UV_INDEX_FIELD,DataTypes.DoubleType)
...
//    .add(TIMEZONE_FIELD,DataTypes.DoubleType)
//    .add(CURRENTLY_FIELD,CURRENTLY_STRUCT)
//    .add(DATE_FIELD,DataTypes.TimestampType)
